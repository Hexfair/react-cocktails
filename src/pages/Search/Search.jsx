...
export const Search = () => {
	...
	const onChangeInput = (event) => setValueInput(event.target.value);
	...
	const drinks = useSearch(valueRadioInput, valueInput, allCocktails);
	...
	return (
		<div className={styles.body}>
			<h2 className={styles.title}>Search by: <span>{valueInput}</span></h2>
